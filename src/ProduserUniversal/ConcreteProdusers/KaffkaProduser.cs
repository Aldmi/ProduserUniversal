...
using ProduserUniversal.ConcreteProdusersOptions;
...
namespace ProduserUniversal.ConcreteProdusers
{
    ...
    /// </summary>
    public class KaffkaProduser : BaseProduser
    {
        #region field
        ...
        public KaffkaProduser(TimeSpan timeRequest, int trottlingQuantity, KaffkaProduserOption option) : base(timeRequest, trottlingQuantity)
        {
            _option = option;
            //_logger = logger;
